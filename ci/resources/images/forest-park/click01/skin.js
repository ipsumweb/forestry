...
// Pano2VR 5.0.1/15068
// Filename: simplex_fPark3.ggsk
// Generated Thu Aug 4 11:09:05 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._welcome__text=document.createElement('div');
		this._welcome.className='ggskin ggskin_textdiv';
		this._welcome.ggTextDiv=this._welcome__text;
		this._welcome.ggId="welcome";
		this._welcome.ggLeft=0;
		this._welcome.ggTop=-172;
		this._welcome.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._welcome.ggVisible=false;
		this._welcome.className='ggskin ggskin_text ';
		this._welcome.ggType='text';
		hs ='';
		hs+='height : 274px;';
		hs+='left : -1px;';
		hs+='position : absolute;';
		...
		hs+='visibility : hidden;';
		hs+='width : 371px;';
		this._welcome.setAttribute('style',hs);
		this._welcome.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 371px;';
		...
		hs+='overflow: hidden;';
		hs+='overflow-y: auto;';
		this._welcome__text.setAttribute('style',hs);
		this._welcome__text.innerHTML="<b>(x)                Welcome to Forest Park                 <\/b><br\/><video width=\"320\" height=\"240\" controls><br\/>  <source src=\"Welcome to Forest Park_V2.mp4\" type=\"video\/mp4\"><br\/>  <source src=\"Welcome to Forest Park_V2.ogg\" type=\"video\/ogg\"><br\/>Your browser does not support the video tag.<br\/><autoplay=\"false\"<br\/>autostart=\"false\"<br\/><\/video><br\/><p>Please Use the video control bar to play and pause the video.<\/p>";
		this._welcome.appendChild(this._welcome__text);
		me._welcome.ggIsActive=function() {
			return false;
		}
		me._welcome.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._welcome.onclick=function () {
			me._welcome.ggVisible = !me._welcome.ggVisible;
			me._welcome.style[domTransition]='none';
			me._welcome.style.visibility=((me._welcome.ggVisible)&&(Number(me._welcome.style.opacity)>0||!me._welcome.style.opacity))?'inherit':'hidden';
			var flag=me._welcome.ggScaleActive;
			if (me.player.transitionsDisabled) {
				me._welcome.style[domTransition]='none';
			} else {
				me._welcome.style[domTransition]='all 500ms ease-out 0ms';
			}
			if (flag) {
				me._welcome.ggParameter.sx=1;me._welcome.ggParameter.sy=1;
				me._welcome.style[domTransform]=parameterToTransform(me._welcome.ggParameter);
			} else {
				me._welcome.ggParameter.sx=1.15;me._welcome.ggParameter.sy=1.15;
				me._welcome.style[domTransform]=parameterToTransform(me._welcome.ggParameter);
			}
			me._welcome.ggScaleActive=!flag;
		}
		this._welcome.ggUpdatePosition=function () {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
					this.style.left=(this.ggLeft - 0 + w/2) + 'px';
		...
		this.divSkin.appendChild(this._welcome);
		this._greennogood=document.createElement('div');
		this._greennogood__text=document.createElement('div');
		this._greennogood.className='ggskin ggskin_textdiv';
		this._greennogood.ggTextDiv=this._greennogood__text;
		this._greennogood.ggId="greennogood";
		this._greennogood.ggLeft=-392;
		this._greennogood.ggTop=-173;
		this._greennogood.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._greennogood.ggVisible=false;
		this._greennogood.className='ggskin ggskin_text ';
		this._greennogood.ggType='text';
		hs ='';
		hs+='height : 274px;';
		hs+='left : -393px;';
		hs+='position : absolute;';
		...
		hs+='visibility : hidden;';
		hs+='width : 371px;';
		this._greennogood.setAttribute('style',hs);
		this._greennogood.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 371px;';
		...
		hs+='overflow: hidden;';
		hs+='overflow-y: auto;';
		this._greennogood__text.setAttribute('style',hs);
		this._greennogood__text.innerHTML="<b>(x)              Green Is Not Always Good               <\/b><br\/><br\/><video width=\"320\" height=\"240\" controls><br\/>  <source src=\"Green is not Always Good_V1.mp4\" type=\"video\/mp4\"><br\/>  <source src=\"Green is not Always Good_V1.ogg\" type=\"video\/ogg\"><br\/>Your browser does not support the video tag.<br\/><\/video><br\/><p>Please Use the video control bar to play and pause the video.<\/p>";
		this._greennogood.appendChild(this._greennogood__text);
		me._greennogood.ggIsActive=function() {
			return false;
		}
		me._greennogood.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._greennogood.onclick=function () {
			me._greennogood.ggVisible = !me._greennogood.ggVisible;
			me._greennogood.style[domTransition]='none';
			me._greennogood.style.visibility=((me._greennogood.ggVisible)&&(Number(me._greennogood.style.opacity)>0||!me._greennogood.style.opacity))?'inherit':'hidden';
			var flag=me._greennogood.ggScaleActive;
			if (me.player.transitionsDisabled) {
				me._greennogood.style[domTransition]='none';
			} else {
				me._greennogood.style[domTransition]='all 500ms ease-out 0ms';
			}
			if (flag) {
				me._greennogood.ggParameter.sx=1;me._greennogood.ggParameter.sy=1;
				me._greennogood.style[domTransform]=parameterToTransform(me._greennogood.ggParameter);
			} else {
				me._greennogood.ggParameter.sx=1.15;me._greennogood.ggParameter.sy=1.15;
				me._greennogood.style[domTransform]=parameterToTransform(me._greennogood.ggParameter);
			}
			me._greennogood.ggScaleActive=!flag;
		}
		this._greennogood.ggUpdatePosition=function () {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
					this.style.left=(this.ggLeft - 0 + w/2) + 'px';
		...
		this.divSkin.appendChild(this._greennogood);
		this._mostwanted=document.createElement('div');
		this._mostwanted__text=document.createElement('div');
		this._mostwanted.className='ggskin ggskin_textdiv';
		this._mostwanted.ggTextDiv=this._mostwanted__text;
		this._mostwanted.ggId="mostWanted";
		this._mostwanted.ggLeft=-228;
		this._mostwanted.ggTop=-181;
		this._mostwanted.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._mostwanted.ggVisible=false;
		this._mostwanted.className='ggskin ggskin_text ';
		this._mostwanted.ggType='text';
		hs ='';
		hs+='height : 285px;';
		hs+='left : -229px;';
		hs+='position : absolute;';
		...
		hs+='visibility : hidden;';
		hs+='width : 425px;';
		this._mostwanted.setAttribute('style',hs);
		this._mostwanted.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 425px;';
		...
		hs+='overflow: hidden;';
		hs+='overflow-y: auto;';
		this._mostwanted__text.setAttribute('style',hs);
		this._mostwanted__text.innerHTML="<b>(x)<\/b><br\/><img src=\"peanut.png\" alt=\"peanuts\" style=\"width:410px;height:36px;\"><br\/><br\/><br\/><a href=\"http:\/\/extension.oregonstate.edu\/gardening\/node\/948\" target=_\"blank\"><img src=\"englishivy2.png\" alt=\"ivy\" style=\"width:171px;height:54px;border:0\"><\/a><br\/><a href=\"https:\/\/www.portlandoregon.gov\/bes\/article\/474845\" target=_\"blank\"><img src=\"englishholly2.png\" alt=\"holly\" style=\"width:185px;height:54px;border:0\"><\/a><br\/><a href=\"http:\/\/rainyside.com\/features\/pest_watch\/Pest_Clematis.html\" target=_\"blank\"><img src=\"clematis2.png\" alt=\"clematis\" style=\"width:300px;height:54px;border:0\"><\/a><br\/><a href=\"http:\/\/www.portlandoregon.gov\/bes\/63979\" target=_\"blank\"><img src=\"garlic2.png\" alt=\"garlic\" style=\"width:198px;height:54px;border:0\"><\/a><br\/><a href=\"http:\/\/weedwise.conservationdistrict.org\/weeds\/himalayan-blackberry-rubus-bifrons\" target=_\"blank\"><img src=\"himalayan2.png\" alt=\"himalayan\" style=\"width:257px;height:54px;border:0\"><\/a><br\/><a href=\"https:\/\/www.oregon.gov\/oisc\/Pages\/most_dangerous.aspx\" target=_\"blank\"><img src=\"worst2.png\" alt=\"worst\" style=\"width:336px;height:54px;border:0\"><\/a><br\/>";
		this._mostwanted.appendChild(this._mostwanted__text);
		me._mostwanted.ggIsActive=function() {
			return false;
		}
		me._mostwanted.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._mostwanted.onclick=function () {
			me._mostwanted.ggVisible = !me._mostwanted.ggVisible;
			me._mostwanted.style[domTransition]='none';
			me._mostwanted.style.visibility=((me._mostwanted.ggVisible)&&(Number(me._mostwanted.style.opacity)>0||!me._mostwanted.style.opacity))?'inherit':'hidden';
			var flag=me._mostwanted.ggScaleActive;
			if (me.player.transitionsDisabled) {
				me._mostwanted.style[domTransition]='none';
			} else {
				me._mostwanted.style[domTransition]='all 500ms ease-out 0ms';
			}
			if (flag) {
				me._mostwanted.ggParameter.sx=1;me._mostwanted.ggParameter.sy=1;
				me._mostwanted.style[domTransform]=parameterToTransform(me._mostwanted.ggParameter);
			} else {
				me._mostwanted.ggParameter.sx=1.15;me._mostwanted.ggParameter.sy=1.15;
				me._mostwanted.style[domTransform]=parameterToTransform(me._mostwanted.ggParameter);
			}
			me._mostwanted.ggScaleActive=!flag;
		}
		this._mostwanted.ggUpdatePosition=function () {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
					this.style.left=(this.ggLeft - 0 + w/2) + 'px';
		...
		this.divSkin.appendChild(this._mostwanted);
		this._invasive=document.createElement('div');
		this._invasive__text=document.createElement('div');
		this._invasive.className='ggskin ggskin_textdiv';
		this._invasive.ggTextDiv=this._invasive__text;
		this._invasive.ggId="invasive";
		this._invasive.ggLeft=-228;
		this._invasive.ggTop=-180;
		this._invasive.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._invasive.ggVisible=false;
		this._invasive.className='ggskin ggskin_text ';
		this._invasive.ggType='text';
		hs ='';
		hs+='height : 405px;';
		hs+='left : -229px;';
		hs+='position : absolute;';
		...
		hs+='visibility : hidden;';
		hs+='width : 415px;';
		this._invasive.setAttribute('style',hs);
		this._invasive.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 415px;';
		...
		hs+='overflow: hidden;';
		hs+='overflow-y: auto;';
		this._invasive__text.setAttribute('style',hs);
		this._invasive__text.innerHTML="<b>(x)                                                                                     <\/b><br\/><img src=\"inspecies.png\" alt=\"invasive\" style=\"width:280px;height:174px;\"><br\/><img src=\"moreinformation2.png\" style=\"width:283px;height:32px;\"><br\/><a href=\"http:\/\/www.invasivespeciesinfo.gov\/whatis.shtml\" target=_\"blank\"><img src=\"usda.png\" alt=\"usda\" style=\"width:200px;height:50px;border:0\"><\/a><br\/><br\/><a href=\"https:\/\/www.nwf.org\/Wildlife\/Threats-to-Wildlife\/Invasive-Species.aspx\" target=_\"blank\"><img src=\"nfw.png\" alt=\"nfw\" style=\"width:223px;height:26px;border:0\"><\/a><br\/><br\/><a href=\"http:\/\/www.usna.usda.gov\/Gardens\/invasives.html\" target=_\"blank\"><img src=\"usna.png\" alt=\"usna\" style=\"width:263px;height:26px;border:0\"><\/a>";
		this._invasive.appendChild(this._invasive__text);
		me._invasive.ggIsActive=function() {
			return false;
		}
		me._invasive.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._invasive.onclick=function () {
			me._invasive.ggVisible = !me._invasive.ggVisible;
			me._invasive.style[domTransition]='none';
			me._invasive.style.visibility=((me._invasive.ggVisible)&&(Number(me._invasive.style.opacity)>0||!me._invasive.style.opacity))?'inherit':'hidden';
			var flag=me._invasive.ggScaleActive;
			if (me.player.transitionsDisabled) {
				me._invasive.style[domTransition]='none';
			} else {
				me._invasive.style[domTransition]='all 500ms ease-out 0ms';
			}
			if (flag) {
				me._invasive.ggParameter.sx=1;me._invasive.ggParameter.sy=1;
				me._invasive.style[domTransform]=parameterToTransform(me._invasive.ggParameter);
			} else {
				me._invasive.ggParameter.sx=1.15;me._invasive.ggParameter.sy=1.15;
				me._invasive.style[domTransform]=parameterToTransform(me._invasive.ggParameter);
			}
			me._invasive.ggScaleActive=!flag;
		}
		this._invasive.ggUpdatePosition=function () {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
					this.style.left=(this.ggLeft - 0 + w/2) + 'px';
		...
		this.divSkin.appendChild(this._invasive);
		...
		this._text_1.ggLeft=-295;
		this._text_1.ggTop=-112;
		...
		this._text_1__text.innerHTML="Click on the circles to learn more! Use the directional arrows below or drag across the screen to navigate this 360 interaction.";
	...
	this.hotspotProxyClick=function(id) {
		...
		if (id=='greennogood') {
			me._greennogood.onclick();
		}
		if (id=='mostWanted') {
			me._mostwanted.onclick();
		}
		if (id=='invasive') {
			me._invasive.onclick();
		}
	}
