...
<html lang="en" ng-app="forestApp" >
  ...
  <body ng-controller="forestController" ng-style="bodyImg"  >   
	...
	<div ng-if="thisPage == '/home'" id="fixed-home"  class="hidden-xs hidden-sm">
		
		<h4 style="color: #fdd449;">Tour Oregon's amazing forests from your computer or smartphone!</h4>
		
		<p>Start your virtual journey!</p>
		
		<a href="/ci/park/forest-park" style="display: block; margin-bottom: 20px;">
			<img class="img img-responsive img-thumbnail" src="/ci/resources/images/_general/home-ad_01 forest park.png" />
		</a>
		
		<a href="/ci/park/working-forests" style="display: block; margin-bottom: 20px;">
			<img class="img img-responsive img-thumbnail" src="/ci/resources/images/_general/home-ad_02 mcdonald.png" />
		</a>
		
		<a href="/ci/park/ashland" style="display: block; margin-bottom: 20px;">
			<img class="img img-responsive img-thumbnail" src="/ci/resources/images/_general/home-ad_03 ashland.png" />
		</a>
		
		<a href="/ci/park/oregon-coast" style="display: block; margin-bottom: 20px;">
			<img class="img img-responsive img-thumbnail" src="/ci/resources/images/_general/home-ad_04 geocoin.png" />
		</a>
		
		<p style="margin-bottom: 20px;">NEW! <a href="/ci/k-12-educators">K-12 Resources</a></p>
